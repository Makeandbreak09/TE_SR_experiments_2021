...
class join(Topo):
    ...
    def dijkstra_computed(self):
        ...
        self.add_command("11", 'echo bash -c \\\"START=\\\\\$SECONDS\; while \! ip netns exec 11 nuttcp -T150 -i1 -R10000 -N32 {4} \>\>flow_11-4.txt 2\>\&1 \; do sleep 1\; echo RTY\: \\\\\$SECONDS \>\>flow_11-4.txt\; done\\\" | at now+2min')
        self.add_command("12", 'echo bash -c \\\"START=\\\\\$SECONDS\; while \! ip netns exec 12 nuttcp -T150 -i1 -R10000 -N32 {4} \>\>flow_12-4.txt 2\>\&1 \; do sleep 1\; echo RTY\: \\\\\$SECONDS \>\>flow_12-4.txt\; done\\\" | at now+2min')
        self.add_command("13", 'echo bash -c \\\"START=\\\\\$SECONDS\; while \! ip netns exec 13 nuttcp -T150 -i1 -R10000 -N32 {4} \>\>flow_13-4.txt 2\>\&1 \; do sleep 1\; echo RTY\: \\\\\$SECONDS \>\>flow_13-4.txt\; done\\\" | at now+2min')
        self.add_command("14", 'echo bash -c \\\"START=\\\\\$SECONDS\; while \! ip netns exec 14 nuttcp -T150 -i1 -R10000 -N32 {4} \>\>flow_14-4.txt 2\>\&1 \; do sleep 1\; echo RTY\: \\\\\$SECONDS \>\>flow_14-4.txt\; done\\\" | at now+2min')
